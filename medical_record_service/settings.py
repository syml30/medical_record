...
STATIC_URL = '/medical_record_static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'medical_record_files')

# Media files (Images, Videos, Voices, Documents)

MEDIA_URL = '/medical_record_media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'medical_record_uploads')
